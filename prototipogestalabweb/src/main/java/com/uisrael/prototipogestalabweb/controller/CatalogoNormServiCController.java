...
public class CatalogoNormServiCController {
	...
	public String mostrarFormularioEditar(@PathVariable int id, Model model) {
		try {
			...
			form.setParametroCatalogoNormServiEntity(actual.getParametroCatalogoNormServiEntity());
			form.setLmpCatalogoNormServiEntity(actual.getLmpCatalogoNormServiEntity());
