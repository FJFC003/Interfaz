...
public class EmpleadoController {
    ...
    // Save new employee (creates Usuario + UsuariohasRol first, then links them)
    @PostMapping("/guardar")
    public String guardarEmpleado(
    	...
    	try {
    		...
    		// final, cada rechazo dejaria una cuenta de usuario y una asignacion
    		// de rol huerfanas en la base.
    		String avisoFechas = errorEnFechasDelEmpleado(empleado);
    		if (avisoFechas != null) {
    			return mostrarAviso(model, empleado, avisoFechas);
    		}

    		// La cedula se comprueba ANTES de crear la cuenta de usuario y el rol.
    		...
    		// 3. Link the generated id and save the employee.
    		// fkFirmaElectronica queda en 0: el backend lo interpreta como null.
